...
public class SymptomCheckerSuggestionAdapter extends RecyclerView.Adapter<SymptomCheckerSuggestionAdapter.ViewHolder> {
    ...
    SymptomCheckerSuggestionAdapter(Context context, List<String> data) {
        this.mInflater = LayoutInflater.from(context);
        this.mData = data;
    }

    public SymptomCheckerSuggestionAdapter() {
